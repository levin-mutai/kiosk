...
def test_product_update():
    product_0.object.update(name="updated test Product", price=5000, stock=21, description="A very quality product to work with.", image_url="")   
...
def test_order_update():
    client = APIClient()
    url = reverse('Orders_detail', args=[1])
    data = {
    "user_id": 1,
    "products":[
        {
